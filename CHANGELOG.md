...
## Changed
- Some more styling on the buttons missing from the last iteration.
- The thumbnail function has been rewritten to now use kalturaId instead of fileId (this is a breaking change).

## [1.1.10] - 2026-05-20

## Changed
- A few missing buttons has now been converted to the KBButton component.
- The timeline function on the frontpage now sorts randomly on the initial call aswell.

# Added
- New annotations from preservica on audio programs.
...
## Changed
- changed archive completion procentage to be recieved from bff - this means no release to update that number \o/.
- updated the slider to account for a larger span of years in the archive.

### Added
- small intro animation to hero element.
- Added new thumbnails for audio entities.

## [1.1.7] - 2025-09-29

## Changed
- small design adjustments.
- changed archive completion procentage from 30% to 37%.

## [1.1.6] - 2025-08-27

## Changed
- Added a check in our episode logic to make sure we don't get any JS errors when data is missing.
