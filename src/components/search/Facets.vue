		...
		<div class="facet-container">
			...
			<div class="category-container">
				...
				<FilterExpander
					...
					icon="category"
					:data-testid="addTestDataEnrichment('checkbox', 'facets', 'filter-expander', 0)"
				...
				<FilterExpander
					...
					icon="play_circle"
					:data-testid="addTestDataEnrichment('checkbox', 'facets', 'filter-expander', 1)"
				...
				<FilterExpander
					...
					icon="volume_up"
					:data-testid="addTestDataEnrichment('checkbox', 'facets', 'filter-expander', 2)"
				...
				<FilterExpander
					...
					icon="calendar_today"
					:data-testid="addTestDataEnrichment('checkbox', 'facets', 'filter-expander', 3)"
